...
import Schwelle from "../components/schwelle.vue";
</script>
...
.logo {
  height: 50px;
  width: auto;
  /* Inline SVG: no nested browsing context, so there is no logo
     background at all — only the red glyph paints, the rest is the
     slide colour. */
}
